...
function AdoptForm(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://51.20.183.104:4000/form/save', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="custom-adopt-form-container">
      <h2 className="custom-form-heading">Blood acquiring Application</h2>
      <div className="form-pet-container">
        <div className="pet-details">
          <div className="pet-pic">
            <img src={`http://51.20.183.104:4000/images/${props.pet.filename}`} alt={props.pet.name} />
          </div>
        ...
        <div className="form-div">
          <form onSubmit={handleSubmit} className="custom-form">
            ...
            <div className="custom-input-box">
              <label className="custom-label">Why do you want blood:</label>
              <input
                type="text"
            ...
            <div className="custom-input-box">
              <label className="custom-label">Do you need blood regularly:</label>
              <input
                type="text"
